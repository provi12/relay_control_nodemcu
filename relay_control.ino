...
if(client.connect("clientId-rXW0pUh1hx"))
{
Serial.println("Connected");
client.publish("home_mqtt_topic/1","Connected!");
...
Serial.println("Waiting for 2 seconds to try again");
delay(2000);
 }
 }
}
